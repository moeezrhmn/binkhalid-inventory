                ...
                <div class="flex  items-center ms-3">
                    <div>
                        <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                            ...
                            <img class="w-8 h-8 rounded-full" src="https://placehold.co/800x800/png" alt="user photo">
                        </button>
                    </div>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('admin.order.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                   <img src="https://img.icons8.com/?size=100&id=59857&format=png&color=000000" class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" alt="">
                    <span class="flex-1 ms-3 whitespace-nowrap">Order</span>
                </a>
            </li>
            <li>
                <a href="{{ route('admin.order.ordered_items') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                   <img src="https://img.icons8.com/?size=100&id=59857&format=png&color=000000" class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" alt="">
                    <span class="flex-1 ms-3 whitespace-nowrap">Ordered Items</span>
                </a>
            </li>
        </ul>
    </div>
